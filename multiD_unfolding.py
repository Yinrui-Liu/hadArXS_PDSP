...
if __name__ == "__main__":
    ...
    true_SIDini, true_SIDend, true_SIDint_ex = calcXS.get_sliceID_histograms(true_Eini, true_Eend, true_flag, true_isCt, true_bins)
    ...
    meas_SIDini, meas_SIDend, meas_SIDint_ex = calcXS.get_sliceID_histograms(reco_Eini, reco_Eend, reco_flag, reco_isCt, meas_bins)
