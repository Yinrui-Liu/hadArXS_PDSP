...
def divide_vars_by_partype(vars, particle_type, mask=None, weight=None, alltypes=None):
    if alltypes is None:
        alltypes = [20, 11, 12, 13, 14, 15, 16, 21, 22, 23, 24, 25, 26, 27] # changed to adapt new GetParType, only works for pion beam
    divided_vars = []
    divided_weights = []
    if mask is None:
